...
//  int sentencesParsed;
  ...
  public CoarseToFineMaxRuleParser(Grammar gr, Lexicon lex, double unaryPenalty, int endL, 
    ...
    if (initializeCascade) initCascade(gr,lex);
  }
...
//      System.out.println("For parsing "+sentencesParsed+" I hat to touch "+edgesTouched/((double)sentencesParsed)+" on average.");
	  ...
	  public double getLogLikelihood(){
	  	...
	  	double logScore = Math.log(iScore[0][length][0][0]);
//	  	double scale = (ScalingTools.LOGSCALE*iScale[0][length][0]); 
	  ...
	  void doConstrainedMaxCScores(List<String> sentence, Grammar grammar, Lexicon lexicon, final boolean scale) {
	    ...
	    ArrayUtil.fill(maxcScore, initVal);
