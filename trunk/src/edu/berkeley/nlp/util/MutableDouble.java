...
public final class MutableDouble extends Number implements Comparable {
  ...
  /**
   * Compares this <code>MutableDouble</code> object to another object.
   * If the object is an <code>MutableDouble</code>, this function behaves
   * like <code>compareTo(MutableDouble)</code>.  Otherwise, it throws a
   * <code>ClassCastException</code> (as <code>MutableDouble</code>
   * objects are only comparable to other <code>MutableDouble</code>
   * objects).
   *
