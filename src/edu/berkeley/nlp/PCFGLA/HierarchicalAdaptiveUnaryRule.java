...
//	private short updateMapping(short myID, int nextChildSubstate,  int nextParentSubstate, int myDepth, int finalDepth, Tree<Double> tree) {
//		if (tree.isLeaf()){
...
//	private short fillScores(short myID, double previousScore, int nextChildSubstate, int nextParentSubstate, int myDepth, int finalDepth, Tree<Double> tree){
//		if (tree.isLeaf()){
